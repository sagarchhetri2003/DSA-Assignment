...
public class ImpactedNetworkDevices {
    ...
    public static List<Integer> findImpactedDevices(int n, List<List<Integer>> connections, int targetDevice) {
        disc = new int[n];
        low = new int[n];
        for (int i = 0; i < n; i++)
    ...
    public static void main(String[] args) {
        ...
        List<Integer> impactedDevices = Collections.unmodifiableList(ImpactedNetworkDevices.findImpactedDevices(n, connections, targetDevice));
